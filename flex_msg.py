...
#            share_url = heroku_APP_url + '/share_vedio?image_url=' + image_url + '&vedio_url=' + vedio_url + '&channel_img=' + channel_img #+ '&channel_name=' + channel_name
            share_url = heroku_APP_url + '/share_vedio?image_url=' + image_url + '&vedio_url=' + vedio_url + '&title=' +  quote(title.encode('utf8')) + '&channel_img=' + channel_img + '&channel_name=' + quote(channel_name.encode('utf8'))
